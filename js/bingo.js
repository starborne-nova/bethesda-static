var bingo = function (bingoList, size) {
	...
	$("#row1").on("mouseenter", function () { $(".row1").addClass("hover"); }).on("mouseleave", function () { $(".row1").removeClass("hover"); });
	$("#row2").on("mouseenter", function () { $(".row2").addClass("hover"); }).on("mouseleave", function () { $(".row2").removeClass("hover"); });
	$("#row3").on("mouseenter", function () { $(".row3").addClass("hover"); }).on("mouseleave", function () { $(".row3").removeClass("hover"); });
	$("#row4").on("mouseenter", function () { $(".row4").addClass("hover"); }).on("mouseleave", function () { $(".row4").removeClass("hover"); });
	$("#row5").on("mouseenter", function () { $(".row5").addClass("hover"); }).on("mouseleave", function () { $(".row5").removeClass("hover"); });

	$("#col1").on("mouseenter", function () { $(".col1").addClass("hover"); }).on("mouseleave", function () { $(".col1").removeClass("hover"); });
	$("#col2").on("mouseenter", function () { $(".col2").addClass("hover"); }).on("mouseleave", function () { $(".col2").removeClass("hover"); });
	$("#col3").on("mouseenter", function () { $(".col3").addClass("hover"); }).on("mouseleave", function () { $(".col3").removeClass("hover"); });
	$("#col4").on("mouseenter", function () { $(".col4").addClass("hover"); }).on("mouseleave", function () { $(".col4").removeClass("hover"); });
	$("#col5").on("mouseenter", function () { $(".col5").addClass("hover"); }).on("mouseleave", function () { $(".col5").removeClass("hover"); });

	$("#tlbr").on("mouseenter", function () { $(".tlbr").addClass("hover"); }).on("mouseleave", function () { $(".tlbr").removeClass("hover"); });
	$("#bltr").on("mouseenter", function () { $(".bltr").addClass("hover"); }).on("mouseleave", function () { $(".bltr").removeClass("hover"); });
